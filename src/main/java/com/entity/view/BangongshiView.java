...
public class BangongshiView extends BangongshiEntity implements Serializable {
	...
	public BangongshiView() {

	}

	public BangongshiView(BangongshiEntity bangongshiEntity) {
		try {
			BeanUtils.copyProperties(this, bangongshiEntity);
