...
public class BangongwuziShenqingEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BangongwuziShenqingEntity() {

	}

	public BangongwuziShenqingEntity(T t) {
		try {
    ...
    public String toString() {
        return "BangongwuziShenqing{" +
            "id=" + id +
            ", jiaoshiId=" + jiaoshiId +
            ", bangongwuziId=" + bangongwuziId +
            ", insertTime=" + insertTime +
            ", bangongwuziShenqingYesnoTypes=" + bangongwuziShenqingYesnoTypes +
